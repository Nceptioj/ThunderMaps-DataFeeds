...
import time
import sys
sys.path.append(r"/usr/local/thundermaps") #/home/fraser/Thundermaps/ThunderMaps-DataFeeds /usr/local/thundermaps
...
class Flickr:
    ...
    def getDescription(self):
        ...
        #Image
        desc_lst.append("</br><a href=\"" + self.image_url + "\">"+"See image on Flickr"+"</a>")
