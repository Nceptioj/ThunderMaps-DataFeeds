"""This module uses a 911 Dispatch - GeoRSS feed from the Columbia City Government to format the data for application use. The data is released on a 6-hour delay unless emergencies require a more frequent update.
    ...
    def format_feed(self):
        ...
        for item in tree.iter(tag='item'):
            ...
            listing = {"occurred_on":format_date, 
                        ...
                        "category_name": item.find('title').text.title() + ' - Columbia 911 Dispatch',
