"""This module uses a Roadworks - GeoRSS feed from the Tennessee Department of Transportation to format the data for application use.
    ...
    def format_feed(self):
        ...
        for item in tree.iter(tag='item'):
            ...
            listing = {"occurred_on":format_date, 
                        ...
                        "category_name":title[0].title() + ' - Roadworks',
